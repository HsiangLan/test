...
export class Ryu extends Fighter {
    constructor(x, y, direction, playerId) {
        ...
        this.frames = new Map([
            ...
            ['jump-up-5', [[319, 234, 48, 86],[25, 106]]],
            ['jump-up-6', [[375, 244, 55, 103],[31, 113]]],

            //  JUMP Forward/Backward
            ['jump-roll-1', [[878, 261, 55, 103],[25 ,106]]],
            ...
            ['jump-roll-7', [[883, 261, 54, 109],[32, 107]]],
        ...
        this.animations = {
            ...
            [FighterState.JUMP_BACKWARD]:  [
                ['jump-roll-4', 200], ['jump-roll-6', 50], ['jump-roll-5', 50], 
